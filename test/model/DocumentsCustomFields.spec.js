...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentsCustomFields', function() {
      beforeEach(function() {
        instance = new GetAccept.DocumentsCustomFields();
      });

      it('should create an instance of DocumentsCustomFields', function() {
        // TODO: update the code to test DocumentsCustomFields
        expect(instance).to.be.a(GetAccept.DocumentsCustomFields);
      });
