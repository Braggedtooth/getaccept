...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UploadVideoBody1', function() {
      beforeEach(function() {
        instance = new GetAccept.UploadVideoBody1();
      });

      it('should create an instance of UploadVideoBody1', function() {
        // TODO: update the code to test UploadVideoBody1
        expect(instance).to.be.a(GetAccept.UploadVideoBody1);
      });
