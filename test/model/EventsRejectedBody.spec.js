...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventsRejectedBody', function() {
      beforeEach(function() {
        instance = new GetAccept.EventsRejectedBody();
      });

      it('should create an instance of EventsRejectedBody', function() {
        // TODO: update the code to test EventsRejectedBody
        expect(instance).to.be.a(GetAccept.EventsRejectedBody);
      });
