...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventsSignedBody', function() {
      beforeEach(function() {
        instance = new GetAccept.EventsSignedBody();
      });

      it('should create an instance of EventsSignedBody', function() {
        // TODO: update the code to test EventsSignedBody
        expect(instance).to.be.a(GetAccept.EventsSignedBody);
      });
