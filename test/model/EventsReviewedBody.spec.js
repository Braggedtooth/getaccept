...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventsReviewedBody', function() {
      beforeEach(function() {
        instance = new GetAccept.EventsReviewedBody();
      });

      it('should create an instance of EventsReviewedBody', function() {
        // TODO: update the code to test EventsReviewedBody
        expect(instance).to.be.a(GetAccept.EventsReviewedBody);
      });
