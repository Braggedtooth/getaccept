...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UploadVideoBody', function() {
      beforeEach(function() {
        instance = new GetAccept.UploadVideoBody();
      });

      it('should create an instance of UploadVideoBody', function() {
        // TODO: update the code to test UploadVideoBody
        expect(instance).to.be.a(GetAccept.UploadVideoBody);
      });
