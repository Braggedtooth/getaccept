...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Recipients', function() {
      beforeEach(function() {
        instance = new GetAccept.Recipients();
      });

      it('should create an instance of Recipients', function() {
        // TODO: update the code to test Recipients
        expect(instance).to.be.a(GetAccept.Recipients);
      });
