...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ContactsBody', function() {
      beforeEach(function() {
        instance = new GetAccept.ContactsBody();
      });

      it('should create an instance of ContactsBody', function() {
        // TODO: update the code to test ContactsBody
        expect(instance).to.be.a(GetAccept.ContactsBody);
      });
