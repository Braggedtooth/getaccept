...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UploadAttachmentBody', function() {
      beforeEach(function() {
        instance = new GetAccept.UploadAttachmentBody();
      });

      it('should create an instance of UploadAttachmentBody', function() {
        // TODO: update the code to test UploadAttachmentBody
        expect(instance).to.be.a(GetAccept.UploadAttachmentBody);
      });
