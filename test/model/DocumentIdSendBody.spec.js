...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentIdSendBody', function() {
      beforeEach(function() {
        instance = new GetAccept.DocumentIdSendBody();
      });

      it('should create an instance of DocumentIdSendBody', function() {
        // TODO: update the code to test DocumentIdSendBody
        expect(instance).to.be.a(GetAccept.DocumentIdSendBody);
      });
