...
import {InlineResponse2005Roles} from './InlineResponse2005Roles';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('roles'))
        obj.roles = ApiClient.convertToType(data['roles'], [InlineResponse2005Roles]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/InlineResponse2005Roles>} roles
 */
InlineResponse2005.prototype.roles = undefined;
